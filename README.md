About nomad-camels-driver-keithley-220-feedstock
================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/nomad-camels-driver-keithley-220-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/nomad-camels-driver-keithley-220-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add nomad-camels-driver-keithley-220
# for installing globally
pixi global install nomad-camels-driver-keithley-220
```
...
It is possible to list all of the versions of `nomad-camels-driver-keithley-220` available on your platform:
...
```
pixi search nomad-camels-driver-keithley-220 --channel conda-forge
```
